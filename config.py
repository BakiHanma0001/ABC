...
OWNER_USERNAME = getenv("OWNER_USERNAME", "baki_hanma_0001")

#❖  Get Your bot username without @
BOT_USERNAME = getenv("BOT_USERNAME", "hanmaXrobot")

#❖  Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "HANMA ROBOT")

#❖ Get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "Baki_Hanma_0001")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002067491336"))

#❖ Get this value from @Miss_RoseBot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6439346165"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BakiHanma0001/ABC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Satan_Network")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Satan_Fucker")
